...
export default function DashboardPage() {
  ...
  const handleDeactivateNewsletter = async () => {
    ...
    try {
      ...
      setNotification({
        message: "Failed to deactivate newsletter",
        type: "error",
      });
    }
  };
  ...
  const handleActivateNewsletter = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setNotification({
          message: "Newsletter activated successfully",
          type: "success",
        });
      }
    } catch (error) {
      console.error("Error activating newsletter:", error);
      setNotification({ message: "Failed to activate newsletter", type: "error" });
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Subscription Status */}
          <SubscriptionCard subscription={subscription} onRefresh={refreshSubscription} />
