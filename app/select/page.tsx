...
export default function SelectPage() {
  ...
  const handleSavePreferences = async (e: React.FormEvent) => {
    ...
    if (!user) {
      setNotification({ message: "Please sign in to continue", type: "error" });
      return;
    }
    ...
    try {
      ...
      setNotification({ message: "Your newsletter preferences have been saved!", type: "success" });
      router.push("/dashboard");
    } catch (error) {
      console.error("Error:", error);
      setNotification({ message: "Failed to save preferences. Please try again.", type: "error" });
    } finally {
      setIsSaving(false);
    }
  };
